...
<?php if (isset($_SESSION['Position-alert_success']) && $_SESSION['Position-alert_success'] != '') { ?>
    ...
    <div class="page-title">
        <h3 class="font-weight-bold text-primary">Pag-Ibig</h3>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addPag_Ibig">Add Pag-Ibig</button>
        </div>
