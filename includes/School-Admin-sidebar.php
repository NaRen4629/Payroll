...
<!-- Sidebar - Brand -->
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="School_Admin_index.php">
...
<li class="nav-item active">
    <a class="nav-link" href="School_Admin_index.php">
...
<li class="nav-item">
    ...
    <div id="Util" class="collapse" aria-labelledby="headingUtilities"
...
<li class="nav-item">
    ...
    <div id="Repo" class="collapse" aria-labelledby="headingUtilities"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Utilities:</h6>
