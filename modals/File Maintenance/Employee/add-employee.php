         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-5 pt-3">M.I:</div>
                        <div class="col-sm-7 pt-3">
                            <input type="text" class="form-control form-control-sm" name="Middle_Name" value="" >
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 pt-3">
                            <input type="text" class="form-control form-control-sm" name="Last_Name" value="" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-5 pt-3"><span class="required">*</span>Type:</div>
                        <div class="col-sm-7 pb-2 pt-3">
                            <select id="Position" name="Type" class="form-select form-select-sm" required>
...
<!-- 
                    <div class="row">
                        ...
                        <div class="col-sm-7 pt-3">
                        <input type="tel" id="phone" name="Contact_Number"pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"><br><br>
                        </div>
                    </div> -->
