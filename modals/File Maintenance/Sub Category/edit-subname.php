    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold text-primary" id="exampleModalLabel"> Edit Sub Category</h5>
                ...
                <form method="POST" action="crud-operation.php?id=<?php echo $subcat['sub_cat_id']; ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 pb-3 pt-3">
                            <select id="subnameStatus" name="subnameStatus" class="form-select form-select-sm" value="<?php echo $subcat['sub_cat_status'] ?>" required>
                                <option salected><?php echo $subcat['sub_cat_status']; ?></option>
