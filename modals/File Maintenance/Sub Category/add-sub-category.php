                ...
                <form method="POST" action="crud-operation.php" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 pt-3">
                            <textarea type="text" class="form-control form-control-sm" id="catsubdescription" name="catsubdescription"></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 pb-3 pt-3">
                            <select id="subcatstatus" name="subcatstatus" class="form-select form-select-sm" required>
