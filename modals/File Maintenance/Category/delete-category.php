    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title font-weight-bold text-primary" id="myModalLabel">Delete Category</h5>
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="crud-operation.php">
                    ...
                    <button type="submit" name="deleteCategory" class="btn btn-sm btn-danger">Yes</button>
                </form>
            </div>
        </div>
    </div>
