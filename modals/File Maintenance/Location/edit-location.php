    ...
    <div class="modal-dialog modal-dialog-centered"">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold text-primary" id="exampleModalLabel"> Edit location</h5>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" class="form-control form-control-sm" name="loc_id" value="<?php echo $loc['loc_id']; ?>">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn  btn-sm  btn-primary" name="editlocation">Update</button>
